 ...
 * Adds Utube widget.
 */
class Utube_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'utube_widget', // Base ID
			esc_html__( 'Utube', 'utb_domain' ), // Name
			array( 'description' => esc_html__( 'Widget to display Youtube Subs', 'utb_domain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		echo $args['before_widget']; //Display anything before widget (<div>, etc)
    ...
    //Widget Output
		...
		echo $args['after_widget']; //Display anything after widget (</div>, etc)
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Youtube Subs', 'utb_domain' );
    $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'techguyweb', 'utb_domain' );
    $layout = ! empty( $instance['layout'] ) ? $instance['layout'] : esc_html__( 'default', 'utb_domain' );
    $count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( 'default', 'utb_domain' );
		?>

    <!-- Title -->
		<p>
		    <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>">
          <?php esc_attr_e( 'Title:', 'utb_domain' ); ?>
        </label>
    ...
    <!-- Channel -->
		<p>
          ...
          <?php esc_attr_e( 'Channel:', 'utb_domain' ); ?>
        </label>
    ...
    <!-- Layout -->
		<p>
          ...
          <?php esc_attr_e( 'Layout:', 'utb_domain' ); ?>
        </label>
    ...
    <!-- Count Subscriber -->
		<p>
          ...
          <?php esc_attr_e( 'Subscriber Count:', 'utb_domain' ); ?>
        </label>
